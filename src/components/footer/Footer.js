          ...
          <div className="row">
            <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
              <div className="widget about-widget">
                <div className="widget-title">
                  <h2>Best Pet Care Agency For Your Favorite Pets</h2>
                </div>
            ...
            <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
              <div className="widget contact-widget">
                ...
                <ul>
                  <li>hundecoachsabine@gmail.com</li>
                  <li>+(91) 9900172766</li>
                  <li>
                    3rd Cross Rd, BEL Layout,
                    <br /> 2nd Block, Vidyaranyapura,
                    <br /> Bengaluru, Karnataka 560097
                  </li>
                </ul>
              </div>
            </div>
              ...
              <ul className="right">
                <li>
                  <Link onClick={ClickHandler} to="/privace">
                    <span className="rolling-text">Privace & Policy</span>{" "}
                  </Link>
                </li>
                <li>
