...
const testimonials = [
  {
    id: "01",
    Des: "Sabine has been incredible with our Husky, Shadow. Her calm and structured training approach helped him become more focused and responsive. We finally understand how to communicate with him better. Highly recommended!",
    title: "Nisha Rao",
    sub: "Owner of a Husky",
    Image: Img1,
  },
  {
    id: "02",
    Des: "Our Indie pup, Bruno, struggled with leash pulling and reactivity. After just a few sessions with Sabine, we saw a huge improvement. Her guidance to us as owners was just as helpful as the training she did with him.",
    title: "Arjun & Meera",
    sub: "Parents of an Indie",
    Image: Img1,
  },
  {
    id: "03",
    Des: "Sabine’s Board & Train program was a blessing. My Labrador, Coco, came back more confident, calmer around visitors, and much better with basic obedience. The regular updates and videos kept me reassured throughout.",
    title: "Rohit Shetty",
    sub: "Owner of a Labrador",
    Image: Img1,
  },
];
